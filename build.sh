...
commonCFlags="-O3 -fsanitize=undefined -flto=thin -ffunction-sections -fdata-sections -mcpu=oryon-1 -fPIC -fno-semantic-interposition -ftls-model=global-dynamic"
